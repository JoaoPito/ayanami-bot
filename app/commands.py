...
class MessageCommand(CommandBase):
    ...
    async def handle(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await context.bot.send_message(chat_id=update.effective_chat.id, text=result["output"], connect_timeout=60)
...
class ResetCommand(CommandBase):
    ...
    async def handle(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await context.bot.send_message(chat_id=update.effective_chat.id, text="Ok!", connect_timeout=60)
...
class PingCommand(CommandBase):
    ...
    async def handle(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        await context.bot.send_message(chat_id=update.effective_chat.id, text="pong", connect_timeout=60)
